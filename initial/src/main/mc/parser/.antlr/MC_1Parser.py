# Generated from d:\BK\HK191\PPL\Assignment1\Principles-Programming-Language\initial\src\main\mc\parser\MC_1.g4 by ANTLR 4.7.1
# encoding: utf-8
from antlr4 import *
...
class MC_1Parser ( Parser ):

    grammarFileName = "MC_1.g4"
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(MC_1Parser.EOF, 0)

        def declaration(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.DeclarationContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.DeclarationContext,i)


        def getRuleIndex(self):
            return MC_1Parser.RULE_program
    ...
    def program(self):
        ...
        localctx = MC_1Parser.ProgramContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.BOOLTYPE) | (1 << MC_1Parser.INTTYPE) | (1 << MC_1Parser.VOIDTYPE) | (1 << MC_1Parser.FLOATTYPE) | (1 << MC_1Parser.STRINGTYPE))) != 0):
                self.state = 70
                self.declaration()
                self.state = 75
                self._errHandler.sync(self)
    ...
    class DeclarationContext(ParserRuleContext):
        ...
        def func_declare(self):
            return self.getTypedRuleContext(MC_1Parser.Func_declareContext,0)


        def var_declare(self):
            return self.getTypedRuleContext(MC_1Parser.Var_declareContext,0)


        def getRuleIndex(self):
            return MC_1Parser.RULE_declaration
    ...
    def declaration(self):
        ...
        localctx = MC_1Parser.DeclarationContext(self, self._ctx, self.state)
    ...
    class Array_typeContext(ParserRuleContext):
        ...
        def primitive_type(self):
            return self.getTypedRuleContext(MC_1Parser.Primitive_typeContext,0)


        def LS(self):
            return self.getToken(MC_1Parser.LS, 0)

        def IntLIT(self):
            return self.getToken(MC_1Parser.IntLIT, 0)

        def RS(self):
            return self.getToken(MC_1Parser.RS, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_array_type
    ...
    def array_type(self):
        ...
        localctx = MC_1Parser.Array_typeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.primitive_type()
            self.state = 83
            self.match(MC_1Parser.LS)
            self.state = 84
            self.match(MC_1Parser.IntLIT)
            self.state = 85
            self.match(MC_1Parser.RS)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class Element_of_arrayContext(ParserRuleContext):
        ...
        def ID(self, i:int=None):
            if i is None:
                return self.getTokens(MC_1Parser.ID)
            else:
                return self.getToken(MC_1Parser.ID, i)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_element_of_array
    ...
    def element_of_array(self):
        ...
        localctx = MC_1Parser.Element_of_arrayContext(self, self._ctx, self.state)
        self.enterRule(localctx, 6, self.RULE_element_of_array)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 87
            self.match(MC_1Parser.ID)
            self.state = 88
            self.match(MC_1Parser.LS)
            self.state = 89
            _la = self._input.LA(1)
            if not(_la==MC_1Parser.ID or _la==MC_1Parser.IntLIT):
    ...
    class VariableContext(ParserRuleContext):
        ...
        def ID(self):
            return self.getToken(MC_1Parser.ID, 0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_variable
    ...
    def variable(self):
        ...
        localctx = MC_1Parser.VariableContext(self, self._ctx, self.state)
    ...
    class Multi_varContext(ParserRuleContext):
        ...
        def variable(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.VariableContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.VariableContext,i)


        def COMMA(self, i:int=None):
            if i is None:
                return self.getTokens(MC_1Parser.COMMA)
            else:
                return self.getToken(MC_1Parser.COMMA, i)

        def getRuleIndex(self):
            return MC_1Parser.RULE_multi_var
    ...
    def multi_var(self):
        ...
        localctx = MC_1Parser.Multi_varContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==MC_1Parser.COMMA:
                self.state = 100
                self.match(MC_1Parser.COMMA)
                self.state = 101
                self.variable()
                self.state = 106
                self._errHandler.sync(self)
    ...
    class Var_declareContext(ParserRuleContext):
        ...
        def multi_var(self):
            return self.getTypedRuleContext(MC_1Parser.Multi_varContext,0)


        def SEMI(self):
            return self.getToken(MC_1Parser.SEMI, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_var_declare
    ...
    def var_declare(self):
        ...
        localctx = MC_1Parser.Var_declareContext(self, self._ctx, self.state)
    ...
    class Input_parameterContext(ParserRuleContext):
        ...
        def LB(self):
            return self.getToken(MC_1Parser.LB, 0)

        def RB(self):
            return self.getToken(MC_1Parser.RB, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_input_parameter
    ...
    def input_parameter(self):
        ...
        localctx = MC_1Parser.Input_parameterContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(MC_1Parser.ID)
            self.state = 113
            self.match(MC_1Parser.LB)
            self.state = 114
            self.match(MC_1Parser.RB)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class Output_parameterContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_output_parameter
    ...
    def output_parameter(self):
        ...
        localctx = MC_1Parser.Output_parameterContext(self, self._ctx, self.state)
    ...
    class Array_pointContext(ParserRuleContext):
        ...
        def input_parameter(self):
            return self.getTypedRuleContext(MC_1Parser.Input_parameterContext,0)


        def output_parameter(self):
            return self.getTypedRuleContext(MC_1Parser.Output_parameterContext,0)


        def getRuleIndex(self):
            return MC_1Parser.RULE_array_point
    ...
    def array_point(self):
        ...
        localctx = MC_1Parser.Array_pointContext(self, self._ctx, self.state)
    ...
    class Para_declareContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_para_declare
    ...
    def para_declare(self):
        ...
        localctx = MC_1Parser.Para_declareContext(self, self._ctx, self.state)
    ...
    class Multi_paraContext(ParserRuleContext):
        ...
        def para_declare(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Para_declareContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Para_declareContext,i)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_multi_para
    ...
    def multi_para(self):
        ...
        localctx = MC_1Parser.Multi_paraContext(self, self._ctx, self.state)
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def expression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.ExpressionContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.ExpressionContext,i)
        ...
        def expression_SB(self):
            return self.getTypedRuleContext(MC_1Parser.Expression_SBContext,0)
        ...
        def assoc_expression(self):
            return self.getTypedRuleContext(MC_1Parser.Assoc_expressionContext,0)


        def relational_expression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Relational_expressionContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Relational_expressionContext,i)


        def LT(self):
            return self.getToken(MC_1Parser.LT, 0)

        def LEQ(self):
            return self.getToken(MC_1Parser.LEQ, 0)

        def GT(self):
            return self.getToken(MC_1Parser.GT, 0)

        def GEQ(self):
            return self.getToken(MC_1Parser.GEQ, 0)

        def equality_expression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Equality_expressionContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Equality_expressionContext,i)


        def EQ(self):
            return self.getToken(MC_1Parser.EQ, 0)

        def NOTEQ(self):
            return self.getToken(MC_1Parser.NOTEQ, 0)

        def operands(self):
            return self.getTypedRuleContext(MC_1Parser.OperandsContext,0)


        def AND(self):
            return self.getToken(MC_1Parser.AND, 0)

        def OR(self):
            return self.getToken(MC_1Parser.OR, 0)

        def ASSIGN(self):
            return self.getToken(MC_1Parser.ASSIGN, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_expression
    ...
    def expression(self, _p:int=0):
        ...
        localctx = MC_1Parser.ExpressionContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 24
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 144
                _la = self._input.LA(1)
                if not(_la==MC_1Parser.LS or _la==MC_1Parser.RS):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
                ...
                self.state = 148
                _la = self._input.LA(1)
                if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.LT) | (1 << MC_1Parser.LEQ) | (1 << MC_1Parser.GT) | (1 << MC_1Parser.GEQ))) != 0)):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
                ...
                self.state = 152
                _la = self._input.LA(1)
                if not(_la==MC_1Parser.EQ or _la==MC_1Parser.NOTEQ):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MC_1Parser.ExpressionContext(self, _parentctx, _parentState)
    ...
    class Assoc_expressionContext(ParserRuleContext):
        ...
        def expression(self):
            return self.getTypedRuleContext(MC_1Parser.ExpressionContext,0)
        ...
        def assoc_expression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Assoc_expressionContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Assoc_expressionContext,i)


        def SUB(self):
            return self.getToken(MC_1Parser.SUB, 0)

        def NOT(self):
            return self.getToken(MC_1Parser.NOT, 0)
        ...
        def ADD(self):
            return self.getToken(MC_1Parser.ADD, 0)

        def MUL(self):
            return self.getToken(MC_1Parser.MUL, 0)

        def DIV(self):
            return self.getToken(MC_1Parser.DIV, 0)

        def MOD(self):
            return self.getToken(MC_1Parser.MOD, 0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_assoc_expression
    ...
    def assoc_expression(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MC_1Parser.Assoc_expressionContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 26
        ...
        try:
            ...
            if token in [MC_1Parser.LB]:
                ...
                self.match(MC_1Parser.RB)
                pass
            elif token in [MC_1Parser.SUB, MC_1Parser.NOT]:
                self.state = 182
                _la = self._input.LA(1)
                if not(_la==MC_1Parser.SUB or _la==MC_1Parser.NOT):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
                ...
                pass
            elif token in [MC_1Parser.ID, MC_1Parser.LITs]:
                self.state = 184
                self.operands()
                pass
            else:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MC_1Parser.Assoc_expressionContext(self, _parentctx, _parentState)
                        ...
                        self.state = 188
                        _la = self._input.LA(1)
                        if not(_la==MC_1Parser.ADD or _la==MC_1Parser.SUB):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
                        ...
                        self.state = 191
                        _la = self._input.LA(1)
                        if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.DIV) | (1 << MC_1Parser.MUL) | (1 << MC_1Parser.MOD))) != 0)):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
    ...
    class Expression_SBContext(ParserRuleContext):
        ...
        def expression_SB(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Expression_SBContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Expression_SBContext,i)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_expression_SB
    ...
    def expression_SB(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MC_1Parser.Expression_SBContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 28
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MC_1Parser.Expression_SBContext(self, _parentctx, _parentState)
    ...
    class Relational_expressionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_relational_expression
    ...
    def relational_expression(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MC_1Parser.Relational_expressionContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 30
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MC_1Parser.Relational_expressionContext(self, _parentctx, _parentState)
    ...
    class Equality_expressionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_equality_expression
    ...
    def equality_expression(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MC_1Parser.Equality_expressionContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 32
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MC_1Parser.Equality_expressionContext(self, _parentctx, _parentState)
    ...
    class Index_expressionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_index_expression
    ...
    def index_expression(self):
        ...
        localctx = MC_1Parser.Index_expressionContext(self, self._ctx, self.state)
    ...
    class Invocation_expressionContext(ParserRuleContext):
        ...
        def function_call(self):
            return self.getTypedRuleContext(MC_1Parser.Function_callContext,0)


        def getRuleIndex(self):
            return MC_1Parser.RULE_invocation_expression
    ...
    def invocation_expression(self):
        ...
        localctx = MC_1Parser.Invocation_expressionContext(self, self._ctx, self.state)
    ...
    class List_expressionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_list_expression
    ...
    def list_expression(self):
        ...
        localctx = MC_1Parser.List_expressionContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.SUB) | (1 << MC_1Parser.NOT) | (1 << MC_1Parser.ID) | (1 << MC_1Parser.LB) | (1 << MC_1Parser.LITs))) != 0):
                self.state = 309
                self.expression(0)
                self.state = 314
                self._errHandler.sync(self)
    ...
    class Function_callContext(ParserRuleContext):
        ...
        def list_expression(self):
            return self.getTypedRuleContext(MC_1Parser.List_expressionContext,0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_function_call
    ...
    def function_call(self):
        ...
        localctx = MC_1Parser.Function_callContext(self, self._ctx, self.state)
    ...
    class OperandsContext(ParserRuleContext):
        ...
        def LITs(self):
            return self.getToken(MC_1Parser.LITs, 0)
        ...
        def element_of_array(self):
            return self.getTypedRuleContext(MC_1Parser.Element_of_arrayContext,0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_operands
    ...
    def operands(self):
        ...
        localctx = MC_1Parser.OperandsContext(self, self._ctx, self.state)
    ...
    class DeclareContext(ParserRuleContext):
        ...
        def var_declare(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.Var_declareContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.Var_declareContext,i)


        def getRuleIndex(self):
            return MC_1Parser.RULE_declare
    ...
    def declare(self):
        ...
        localctx = MC_1Parser.DeclareContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.BOOLTYPE) | (1 << MC_1Parser.INTTYPE) | (1 << MC_1Parser.FLOATTYPE) | (1 << MC_1Parser.STRINGTYPE))) != 0):
                self.state = 330
                self.var_declare()
                self.state = 335
                self._errHandler.sync(self)
    ...
    class Break_stmtContext(ParserRuleContext):
        ...
        def Break(self):
            return self.getToken(MC_1Parser.Break, 0)

        def SEMI(self):
            return self.getToken(MC_1Parser.SEMI, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_break_stmt
    ...
    def break_stmt(self):
        ...
        localctx = MC_1Parser.Break_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 46, self.RULE_break_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 336
            self.match(MC_1Parser.Break)
            self.state = 337
            self.match(MC_1Parser.SEMI)
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Continue_stmtContext(ParserRuleContext):
        ...
        def Continue(self):
            return self.getToken(MC_1Parser.Continue, 0)

        def SEMI(self):
            return self.getToken(MC_1Parser.SEMI, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_continue_stmt
    ...
    def continue_stmt(self):
        ...
        localctx = MC_1Parser.Continue_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 48, self.RULE_continue_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 339
            self.match(MC_1Parser.Continue)
            self.state = 340
            self.match(MC_1Parser.SEMI)
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Return_stmtContext(ParserRuleContext):
        ...
        def Return(self):
            return self.getToken(MC_1Parser.Return, 0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_return_stmt
    ...
    def return_stmt(self):
        ...
        localctx = MC_1Parser.Return_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 50, self.RULE_return_stmt)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 342
            self.match(MC_1Parser.Return)
            self.state = 344
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.SUB) | (1 << MC_1Parser.NOT) | (1 << MC_1Parser.ID) | (1 << MC_1Parser.LB) | (1 << MC_1Parser.LITs))) != 0):
    ...
    class Expression_stmtContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_expression_stmt
    ...
    def expression_stmt(self):
        ...
        localctx = MC_1Parser.Expression_stmtContext(self, self._ctx, self.state)
    ...
    class For_stmtContext(ParserRuleContext):
        ...
        def For(self):
            return self.getToken(MC_1Parser.For, 0)
        ...
        def SEMI(self, i:int=None):
            if i is None:
                return self.getTokens(MC_1Parser.SEMI)
            else:
                return self.getToken(MC_1Parser.SEMI, i)

        def RB(self):
            return self.getToken(MC_1Parser.RB, 0)

        def stmt(self):
            return self.getTypedRuleContext(MC_1Parser.StmtContext,0)


        def getRuleIndex(self):
            return MC_1Parser.RULE_for_stmt
    ...
    def for_stmt(self):
        ...
        localctx = MC_1Parser.For_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 54, self.RULE_for_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 351
            self.match(MC_1Parser.For)
            self.state = 352
            self.match(MC_1Parser.LB)
            self.state = 353
            self.expression(0)
    ...
    class Block_stmtContext(ParserRuleContext):
        ...
        def LP(self):
            return self.getToken(MC_1Parser.LP, 0)

        def declare(self):
            return self.getTypedRuleContext(MC_1Parser.DeclareContext,0)


        def statement(self):
            return self.getTypedRuleContext(MC_1Parser.StatementContext,0)


        def RP(self):
            return self.getToken(MC_1Parser.RP, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_block_stmt
    ...
    def block_stmt(self):
        ...
        localctx = MC_1Parser.Block_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 56, self.RULE_block_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 361
            self.match(MC_1Parser.LP)
            self.state = 362
            self.declare()
            self.state = 363
            self.statement()
            self.state = 364
            self.match(MC_1Parser.RP)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class Dowhile_stmtContext(ParserRuleContext):
        ...
        def Do(self):
            return self.getToken(MC_1Parser.Do, 0)
        ...
        def While(self):
            return self.getToken(MC_1Parser.While, 0)
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_dowhile_stmt
    ...
    def dowhile_stmt(self):
        ...
        localctx = MC_1Parser.Dowhile_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 58, self.RULE_dowhile_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 366
            self.match(MC_1Parser.Do)
            self.state = 367
            self.statement()
            self.state = 368
            self.match(MC_1Parser.While)
            self.state = 369
            self.expression(0)
            self.state = 370
            self.match(MC_1Parser.SEMI)
    ...
    class If_stmtContext(ParserRuleContext):
        ...
        def If(self):
            return self.getToken(MC_1Parser.If, 0)
        ...
        def stmt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MC_1Parser.StmtContext)
            else:
                return self.getTypedRuleContext(MC_1Parser.StmtContext,i)


        def Else(self):
            return self.getToken(MC_1Parser.Else, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_if_stmt
    ...
    def if_stmt(self):
        ...
        localctx = MC_1Parser.If_stmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 60, self.RULE_if_stmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 372
            self.match(MC_1Parser.If)
            self.state = 373
            self.match(MC_1Parser.LB)
            self.state = 374
            self.expression(0)
    ...
    class StmtContext(ParserRuleContext):
        ...
        def if_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.If_stmtContext,0)


        def dowhile_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Dowhile_stmtContext,0)


        def for_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.For_stmtContext,0)


        def break_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Break_stmtContext,0)


        def continue_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Continue_stmtContext,0)


        def return_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Return_stmtContext,0)


        def expression_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Expression_stmtContext,0)


        def block_stmt(self):
            return self.getTypedRuleContext(MC_1Parser.Block_stmtContext,0)


        def index_expression(self):
            return self.getTypedRuleContext(MC_1Parser.Index_expressionContext,0)
    ...
    def stmt(self):
        ...
        localctx = MC_1Parser.StmtContext(self, self._ctx, self.state)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MC_1Parser.RULE_statement
    ...
    def statement(self):
        ...
        localctx = MC_1Parser.StatementContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.Break) | (1 << MC_1Parser.Continue) | (1 << MC_1Parser.Do) | (1 << MC_1Parser.If) | (1 << MC_1Parser.For) | (1 << MC_1Parser.Return) | (1 << MC_1Parser.SUB) | (1 << MC_1Parser.NOT) | (1 << MC_1Parser.ID) | (1 << MC_1Parser.LB) | (1 << MC_1Parser.LP) | (1 << MC_1Parser.LITs))) != 0):
                self.state = 394
                self.stmt()
                self.state = 399
                self._errHandler.sync(self)
    ...
    class Func_declareContext(ParserRuleContext):
        ...
        def VOIDTYPE(self):
            return self.getToken(MC_1Parser.VOIDTYPE, 0)
        ...
        def multi_para(self):
            return self.getTypedRuleContext(MC_1Parser.Multi_paraContext,0)


        def getRuleIndex(self):
            return MC_1Parser.RULE_func_declare
    ...
    def func_declare(self):
        ...
        localctx = MC_1Parser.Func_declareContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 401
                self.match(MC_1Parser.VOIDTYPE)
                pass
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.BOOLTYPE) | (1 << MC_1Parser.INTTYPE) | (1 << MC_1Parser.FLOATTYPE) | (1 << MC_1Parser.STRINGTYPE))) != 0):
                self.state = 407
                self.multi_para()
    ...
    class Primitive_typeContext(ParserRuleContext):
        ...
        def INTTYPE(self):
            return self.getToken(MC_1Parser.INTTYPE, 0)

        def FLOATTYPE(self):
            return self.getToken(MC_1Parser.FLOATTYPE, 0)

        def BOOLTYPE(self):
            return self.getToken(MC_1Parser.BOOLTYPE, 0)

        def STRINGTYPE(self):
            return self.getToken(MC_1Parser.STRINGTYPE, 0)

        def getRuleIndex(self):
            return MC_1Parser.RULE_primitive_type
    ...
    def primitive_type(self):
        ...
        localctx = MC_1Parser.Primitive_typeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 413
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MC_1Parser.BOOLTYPE) | (1 << MC_1Parser.INTTYPE) | (1 << MC_1Parser.FLOATTYPE) | (1 << MC_1Parser.STRINGTYPE))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
